...
import { PrivacyLoggerConfig, AuditEvent, VerificationLogData, LogLevel } from './types';
/**
...
export declare class PrivacyLogger {
     ...
     */
    verification(requestId: string, action: string, result: VerificationLogData): void;
    /**
     ...
     */
    response(method: string, url: string, statusCode: number, requestId: string, data?: unknown): void;
    /**
 ...
 */
export declare function createPrivacyLogger(config?: Partial<PrivacyLoggerConfig>): PrivacyLogger;
/**
